...
insert into task(name, description) values('task3', 'daily, end after 30 occurrences');
...
insert into task_occurence(task_id, recurrence, start_date, end_date, status) values (3, 'Daily', now() - interval '1 day', now() + interval '29 day', 'In Progress');
